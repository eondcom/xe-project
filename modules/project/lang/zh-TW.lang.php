<?php
    ...
    $lang->project_main_url = "專案首頁";
    $lang->my_projects = "參加專案";
    $lang->release = "發佈";
    $lang->packages = '套裝軟體';
    $lang->timeline = '時間軸';
    $lang->download = '下載';
    $lang->project_list = '專案列表';
    $lang->project_member_count = '會員數量';
    $lang->developer_member_count = '開發者數量';
    $lang->project_rank = '排行';
    $lang->my_project = '我的專案';
    $lang->project_home = 'Project Home';
    $lang->top_activation_project = '熱門專案 (以一周為主)';
	$lang->rank_activation = '熱門排行';
    $lang->newest_project = '最新專案';
    ...
    $lang->about_notify_mail = '請輸入郵件位址，當有專案註冊請求時會用郵件通知。';

    $lang->cmd_make_project = '建立專案';
    $lang->cmd_import = '匯入';
    $lang->cmd_make_directory = '建立目錄';
    $lang->cmd_make_sub_directory = '建立子目錄';
    $lang->cmd_export = '匯出';
    $lang->cmd_repos_repository = '建立檔案庫';
    ...
    $lang->cmd_project_registration = '專案建立';
    $lang->cmd_directory_registration = '目錄建立';
    $lang->cmd_project_setup = '專案設定';
    $lang->cmd_project_delete = '刪除專案';
    $lang->cmd_go_home = '返回首頁';
    $lang->cmd_go_project_admin = '專案管理';
    $lang->cmd_select_index = '選擇首頁';
    $lang->cmd_add_new_menu = '新增選單';
    $lang->cmd_post_news = '새로운 뉴스 등록';
    $lang->cmd_post_offer = '새로운 구인게시물 등록';
    $lang->cmd_make_my_project = '建立自己的專案';

    $lang->cmd_reject_project_creation = '禁止';
    $lang->cmd_accept_project_creation = '允許';

    $lang->about_project_main_mid = '專案的網址是「http://網址/ID」，請輸入想要的 ID 值。';
    $lang->about_project_rss = '可選擇是否輸出專案首頁 RSS 內容。';
    $lang->about_project_repos = '專案管理員可幫你建立檔案庫。';
    $lang->about_project_repos_url = '提供個人檔案庫，請輸入網址。<br/>所輸入的網址必須是子域名。<br/>輸入 repos.xpressengine.com 的話，檔案庫網址就是 http://repos.xpressengine.com/檔案庫 ID 了。';
    $lang->about_project_main_url = '請輸入專案首頁網址。';
    ...
    $lang->about_project = 'Project 服務管理者可以建立專案同時也能夠輕鬆地對每一個專案進行設定。';
    ...
    $lang->about_menu_image_button = '選單名稱可使用圖片替換。';
    $lang->about_project_delete = 'Project를 삭제하게 되면 연결되어 있는 모든 모듈(討論板，頁面等)과 그에 따른 글들이 삭제됩니다.<br />주의가 필요합니다';
    ...
    $lang->about_project_title = '請輸入專案標題。(4~20 之間)';
    ...
    $lang->about_project_banner = '請上傳專案初始畫面所顯示的廣告圖片。(寬度 180px)';
    ...
    $lang->msg_notify_reserved_content = '專案註冊請求。<br/>捷徑 : <a href="%s">%s</a><br/>';
	...
	$lang->contributor_sort_order = array( "points" => "貢獻點數", "articles" => "主題數", "comments" => "回覆數", "commits" => "提交數" );
	$lang->mysummary_sort_order = array( "point" => "貢獻點數", "member_count" => "會員數", "regdate" => "註冊日期", "joindate" => "加入日期");
	$lang->summary_sort_order = array( "point" => "활성화지수 순", "member_count" => "會員數", "regdate" => "註冊日期" );
	$lang->download_sort_order = array( "download_count" => "下載數", "regdate" => "註冊日期", "oldregdate" => "등록일 오랜 순");
	$lang->projectmilestone = "Milestone";
	$lang->project_title = "專案標題";
	$lang->my_activities = "My Activities";
	$lang->project_setting = "專案設定";
