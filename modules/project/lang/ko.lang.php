<?php
    ...
    $lang->offer = "구인";
    $lang->release = "릴리즈";
    $lang->project_news = '프로젝트 뉴스';
    $lang->post_news = '뉴스 등록';
    $lang->update_news = '뉴스 수정';
    $lang->project_offer = '프로젝트 멤버 구인';
    $lang->post_offer = '구인 게시물 등록';
    $lang->update_offer= '구인 게시물 수정';
    $lang->packages = '패키지';
    $lang->timeline = '타임라인';
    $lang->download = '다운로드';
    ...
    $lang->about_project_logo = '프로젝트 상단 또는 프로젝트 전체 목록에서 나타나는 로고 이미지를 입력해주세요. (200px*40px)';
    $lang->about_project_banner = '프로젝트 초기화면에 나타나는 배너 이미지를 입력해주세요. (180px*140px)';
